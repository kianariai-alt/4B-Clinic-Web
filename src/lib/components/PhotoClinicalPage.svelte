...
<style>
  ...
  @media(max-width:900px){.photo-hero__shade,.photo-hero.copy-left .photo-hero__shade{background:linear-gradient(0deg,rgba(4,13,24,.96) 0%,rgba(4,13,24,.74) 46%,rgba(4,13,24,.16) 100%)}.photo-hero__inner,.photo-hero.copy-left .photo-hero__inner{justify-content:flex-start}.photo-hero__copy{width:min(100%,700px)}.intro-strip,.section-head,.pathway-v2{grid-template-columns:1fr;gap:26px}.condition-grid-v2{grid-template-columns:1fr 1fr}.cta-v2{align-items:flex-start;flex-direction:column}}
