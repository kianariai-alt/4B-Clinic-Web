<script>
  ...
  const logoSrc = '/brand/4b-logo-mark-navy.webp?v=3';
  let visible = false;
  let timer = 0;

  onMount(() => {
    const key = '4b-splash-seen-v3';
